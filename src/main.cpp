...
void setup()
{
    ...
    Serial.println(String("channel {4} offset: ") + String(channels[4].getOffset()));
...
void loop()
{
    ...
    Serial.print(String("channel 4: ") + String(channels[3].read()) + "   ");
    Serial.println(String("channel 5: ") + String(channels[4].read()));
    Serial.flush();
}